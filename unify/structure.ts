...
const I18N_TYPES = ['module', 'submodule', 'lesson', 'checklist']
...
export const structure: StructureResolver = (S) =>
  S.list()
    ...
    .items([
      ...
      S.divider(),
      // Everything else (quiz, practice, task) as default lists; hide the i18n types
      // (handled above) and the plugin's internal translation.metadata documents.
